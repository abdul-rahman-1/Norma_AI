...
async def get_logs_page():
    ...
    <html>
        ...
        <body>
            <div class="header">
                <h1>🏥 Norma AI - Clinical Orchestrator Live Terminal</h1>
                <p>Status: <span style="color: #00ff00;">● Operational</span> | Auto-updating in real-time</p>
            </div>
...
async def get_raw_logs():
    """Returns the last 100 lines as plain text."""
    return Response(content="\n".join(log_buffer), media_type="text/plain")

@app.get("/logs/stream")
async def stream_logs():
    """Streams new logs to the client using Server-Sent Events (SSE)."""
