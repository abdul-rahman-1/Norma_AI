...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { path: '/appointments', icon: Calendar, label: 'Schedule', roles: ['doctor', 'receptionist', 'admin'] },
    { path: '/patients', icon: Users, label: 'Patients', roles: ['doctor', 'receptionist', 'admin'] },
    { path: '/doctors', icon: Stethoscope, label: 'Doctors', roles: ['admin', 'doctor', 'receptionist'] },
    { path: '/bulk-upload', icon: UploadCloud, label: 'Add Data', roles: ['doctor', 'admin'] },
