...
export default function AddDoctor() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Failed to add doctor. Ensure you have admin permissions.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="bg-white rounded-[3rem] p-12 shadow-[0_50px_100px_rgba(0,0,0,0.05)] border border-zinc-100 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <header className="mb-16">
            ...
            <h1 className="text-5xl font-black text-black tracking-tighter uppercase italic leading-none">Register Doctor</h1>
            <p className="text-zinc-400 font-bold text-xs uppercase tracking-[0.4em] mt-4 opacity-60">Initializing specialist profile...</p>
          </header>
          ...
          {success ? (
            ...
            >
              ...
              <h2 className="text-3xl font-black uppercase italic tracking-tighter">Registration Complete</h2>
              <p className="text-zinc-500 font-bold uppercase tracking-widest text-[10px]">Syncing to distributed ledger...</p>
            </motion.div>
          ) : (
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <div className="space-y-4">
                <label className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.3em] ml-2">Specialty</label>
                <div className="relative group">
                  <Award size={20} className="absolute left-6 top-1/2 -translate-y-1/2 text-zinc-300 group-focus-within:text-[#7c3aed] transition-colors" />
                  <input 
                    type="text" 
                    required
              ...
              <div className="space-y-4">
                <label className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.3em] ml-2">WhatsApp Number</label>
                <div className="relative group">
              ...
              <div className="space-y-4">
                <label className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.3em] ml-2">License Number</label>
                <div className="relative group">
                  <FileText size={20} className="absolute left-6 top-1/2 -translate-y-1/2 text-zinc-300 group-focus-within:text-[#7c3aed] transition-colors" />
                  <input 
                    type="text" 
              ...
              <div className="space-y-4">
                <label className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.3em] ml-2">Consultation Fee</label>
                <div className="relative group">
                  <DollarSign size={20} className="absolute left-6 top-1/2 -translate-y-1/2 text-zinc-300 group-focus-within:text-[#7c3aed] transition-colors" />
                  <input 
                    type="number" 
              ...
              <div className="md:col-span-2 space-y-4">
                <label className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.3em] ml-2">Professional Bio</label>
                <textarea 
                  value={formData.bio}
                  onChange={(e) => setFormData({...formData, bio: e.target.value})}
                  rows={4}
                  className="w-full bg-zinc-50 border-2 border-transparent text-black px-8 py-5 rounded-3xl text-sm font-black tracking-tight outline-none focus:bg-white focus:border-black transition-all resize-none"
